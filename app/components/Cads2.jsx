  ...
  return (
    <>
      <div className="md:w-full flex ss:w-full">
        {' '}
        <button className=" flex bg-white rounded-l-md mt-5 p-3 text-xs font-Jost font-light border-solid border-2 border-gray-300">
          <div className="mr-2">
            <svg
              width="13"
              height="15"
      ...
      <div className="bg-white  border-solid border-2 border-gray-300 mt-4 flex justify-between items-center md:w-full py-2 px-3 rounded-t-md ss:w-full">
        <div className="flex justify-center items-center gap-3 mt-1 font-Jost font-medium text-m">
          <svg
            width="26"
            height="27"
            viewBox="0 0 26 27"
        ...
        <button className="bg-blue-500 rounded-xl text-white flex justify-center items-center gap-3 text-xs  ss:p-1.5 ss:px-3 sm:p-2 sm:pl-6 sm:pr-9">
          {' '}
          <svg
            width="11"
            height="11"
        ...
        <table className="md:w-3/4 bg-white border-solid border-gray-300  sm:w-full lg:w-auto">
          <thead>
            <tr>
              ...
              <th className="border border-gray-300 font-Jost font-semibold text-sm pr-64">
                Name
              </th>
